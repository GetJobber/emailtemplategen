...
export default function App() {
  ...
  return (
    <AdminDataContext.Provider value={{ plans: adminState.plans, addons: adminState.addons, jobberPayments: adminState.jobberPayments, onboardingLinks: adminState.onboardingLinks, adminDispatch, isDirty, save, cancel, resetToDefaults }}>
      <DndContext
        sensors={sensors}
