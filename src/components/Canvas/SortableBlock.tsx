...
export function SortableBlock({ block, dispatch }: Props) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="relative group bg-white rounded-xl shadow-sm border border-gray-100 mb-3 hover:border-green-300 hover:shadow-md transition-all"
    >
      {/* Drag handle */}
      <div
        {...attributes}
